...
/**
 * Stimulus-Analyse (Vision) — die EINMALIGE Bild-Analyse eines hochgeladenen
 ...
 *
 * Trigger: AUSSCHLIESSLICH der Bild-Upload in der Stimulus-Route (fail-open —
...
export const MAX_TEXT_BLOCK_CHARS = 2500;
...
export const StimulusAnalysisPayloadSchema = z.object({
  ...
  analysis: StimulusAnalysisSchema,
...
function formatStudyContext(study: StimulusStudyContext): string {
  const topicLines =
