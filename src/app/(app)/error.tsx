...
/**
 * (app)-tree error boundary (twin lives in (marketing) — each root layout
 * needs its own since the shared root was split, Perf-Etappe C). Must be a
 * Client Component. Renders inside the app root layout, so it paints its own
 * light surface over the dark body.
 */
