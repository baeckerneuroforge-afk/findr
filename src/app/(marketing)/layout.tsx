 ...
 * text-white` with Inter; this wrapper paints `bg-white text-neutral-900`, sets
 * the Hanken body face (`font-body`), and fills the viewport so the dark
 * dashboard background never shows through. Header + <main> + Footer wrap every
