...
const META = {
  title: {
    de: "Market Research für Design & Agenturen",
    en: "Market Research for Design & Agencies",
  },
  ogTitle: {
    de: "Market Research für Design & Agenturen — Klymeo",
    en: "Market Research for Design & Agencies — Klymeo",
  },
  description: {
    de: "Konzept- und Creative-Tests mit echten Zielgruppen: Entwürfe, Key-Visuals und Kampagnen als Stimulus direkt im KI-Interview zeigen — Feedback in Tagen statt Wochen, mit Originalzitaten fürs Kunden-Deck und Export als PDF oder PowerPoint im eigenen Branding.",
    en: "Concept and Creative Tests with real target audiences: show drafts, key visuals and campaigns as a Stimulus right in the AI interview — feedback in days instead of weeks, with verbatim quotes for the client deck and export as PDF or PowerPoint in your own branding.",
  },
} as const;
...
function buildJsonLd(locale: Locale) {
  return {
    ...
    name: localizedContent(locale, {
      de: "Klymeo Market Research — Design & Agenturen",
      en: "Klymeo Market Research — Design & Agencies",
    }),
