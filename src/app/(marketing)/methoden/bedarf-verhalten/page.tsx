...
const OG_TITLE = "Bedarf & Verhalten — findr.";
const DESCRIPTION =
  "findr. fragt nach konkreten Situationen und Workarounds statt nach Hypothesen — und bohrt nach, bis echter Bedarf belegt ist. KI-Interviews auf Deutsch, DSGVO-nativ.";
...
const CONTENT: MethodContent = {
  ...
  heroSubhead:
    "Was Menschen sagen, dass sie tun, und was sie wirklich tun, ist selten dasselbe. findr. fragt nach konkreten Situationen und echten Workarounds aus der Vergangenheit — und bohrt nach, bis aus einer Hypothese ein belegter Bedarf wird.",
  audience:
  ...
  how: {
    title: <>So bohrt findr. nach.</>,
    lead:
      "Kein Skript, das bei der ersten Antwort stehenbleibt. findr. arbeitet sich vom konkreten Fall zum belegten Bedarf — wie ein erfahrener Researcher, nur skalierbar.",
    steps: [
      {
        phase: "Situation",
        title: "Nach dem letzten Mal fragen, nicht nach der Regel",
        body: "Statt „Nutzen Sie das?“ fragt findr.: „Erzähl von letzter Woche — wie bist du da vorgegangen?“ Konkrete Episoden statt verallgemeinerter Selbsteinschätzung.",
        tag: "Live",
      },
      {
        phase: "Workaround",
        title: "Den Behelf aufdecken",
        body: "Wo es hakt, hat sich jede Person längst irgendwie beholfen. findr. fragt nach dem Workaround — er zeigt den ungedeckten Bedarf deutlicher als jede Wunschliste.",
        tag: "Live",
      },
      {
        phase: "Nachbohren",
        title: "Komplimente zählen nicht als Signal",
        body: "„Coole Idee“ ist kein Beleg. findr. hakt nach, bis ein konkretes Beispiel auf dem Tisch liegt — und erkennt, wenn Höflichkeit als Begeisterung getarnt ist.",
        tag: "Live",
      },
      {
        phase: "Beleg",
  ...
  result: {
    ...
    body: "Aus jedem Interview verdichtet findr. die wiederkehrenden Situationen, Workarounds und Reibungspunkte zu belegter Evidenz — verankert im Transkript. Über mehrere Interviews hinweg wird deterministisch gezählt, welche Muster wirklich tragen.",
    payoff: {
  ...
  cta: {
    ...
    lead: "Buch eine Demo und sieh, wie findr. in einem Tiefeninterview vom ersten „klingt gut“ zum belegten Bedarf nachbohrt.",
  },
};
